...
func TestHighlightStringRegex(t *testing.T) {
	for _, tt := range []struct {
	...
	}{
		{
			...
			segmentStart:   0,
			segmentEnd:     11,
			expected:       "hello \x1b[38;2;255;0;0mworld\x1b[m",
		},
		{
			...
			segmentStart:   0,
			segmentEnd:     11,
			expected:       "\x1b[38;2;255;0;0mfoo\x1b[m bar \x1b[38;2;255;0;0mfoo\x1b[m",
		},
		{
		...
		},
		{
			...
			styledSegment:  "\x1b[38;2;255;0;0mhello world\x1b[m",
			regexPattern:   "world",
			highlightStyle: lipgloss.NewStyle().Foreground(blue),
			plainLine:      "hello world",
			segmentStart:   0,
			segmentEnd:     11,
			expected:       "\x1b[38;2;255;0;0mhello \x1b[m\x1b[38;2;0;0;255mworld\x1b[m",
		},
		{
		...
		},
		{
			...
			segmentStart:   0,
			segmentEnd:     17,
			expected:       "\x1b[38;2;255;0;0mhello\x1b[m world \x1b[38;2;255;0;0mhello\x1b[m",
		},
		{
			...
			segmentStart:   0,
			segmentEnd:     11,
			expected:       "abc \x1b[38;2;255;0;0m123\x1b[m def",
		},
		{
			...
			segmentStart:   7,
			segmentEnd:     13,
			expected:       "\x1b[38;2;255;0;0mmid\x1b[mdle",
		},
		{
			name:           "empty segment",
			styledSegment:  "",
